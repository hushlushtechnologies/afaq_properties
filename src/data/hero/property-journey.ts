...
export const PROPERTY_JOURNEY_STEPS: JourneyStep[] = [
  ...
  },
  {
    ...
    description:
      "Complete your property journey with confidence. From final documentation to handover, we ensure a smooth experience as you step into your new home or investment.",
  },
];
